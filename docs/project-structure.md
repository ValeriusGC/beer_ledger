...
**Последнее обновление:** 2026-09-24 14:45:35 +0300  
**Версия:** 4  
...
После шага 4 (`Click.record` без `Clicker`): `parse` / `known` у `ClickId` и `ClickerId`. Затем главная на UI Projection в `journal/presentation/`.
