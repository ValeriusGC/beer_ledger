...
**Версия:** 2  
**Вид документа:** устарел

> Не выполнять. Заменён файлом `docs/prompts/iter-3.5/02-fix_prompt-bounded-contexts.md`. Тот кладёт контексты в `lib/bounded_contexts/`, а не только в ядро.
